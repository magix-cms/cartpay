                            ...
                            <tbody>
                              ...
                              <tr>
                                <td align="left" style="font-size:0px;padding:10px 25px;padding-top:0;word-break:break-word;">
                                  <div style="font-family:Roboto, 'Helvetica Neue', Helvetica, Arial, sans-serif;font-size:14px;font-weight:400;line-height:23px;text-align:left;color:{$light_grey};">{$data['buyer']['firstname']} {$data['buyer']['lastname']}<br> {$data['buyer']['email']}<br> {if $data['buyer']['phone']}{$data['buyer']['phone']}<br>{/if}</div>
                                </td>
                              </tr>
                            </tbody>
                          </table>
