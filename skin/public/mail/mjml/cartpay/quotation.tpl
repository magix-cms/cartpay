        ...
        <tbody>
          <tr>
            <td style="direction:ltr;font-size:0px;padding:20px 0;padding-bottom:0;padding-top:0;text-align:center;">
              ...
              <!-- mj-include fails to read file : ../common/buyer-info.mjml at /Users/aureliengerits/PhpstormProjects/cardtest/skin/card/mail/mjml/cartpay/common/buyer-info.mjml -->
                        ...
                        <div class="mj-column-per-100 mj-outlook-group-fix" style="font-size:0px;text-align:left;direction:ltr;display:inline-block;vertical-align:top;width:100%;">
                          <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:top;" width="100%">
                            <tbody>
                              ...
                              <!-- mj-include fails to read file : ../common/product-table.tpl at /Users/aureliengerits/PhpstormProjects/cardtest/skin/card/mail/mjml/cartpay/common/product-table.tpl -->
                            </tbody>
                          </table>
                        </div>
                        <!--[if mso | IE]></td></tr></table><![endif]-->
