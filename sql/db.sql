CREATE TABLE IF NOT EXISTS `mc_plugins_cartpay` (
  ...
  `company_cart` varchar(45) DEFAULT NULL,
  ...
  `vat_cart` varchar(45) DEFAULT NULL,
  `message_cart` text,
...
CREATE TABLE IF NOT EXISTS `mc_plugins_cartpay_module` (
...
TRUNCATE `mc_plugins_cartpay_tva_conf`;
