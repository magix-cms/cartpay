        ...
        <div class="modal-content">
            ...
            <form action="" id="form_edit_qty" method="post" class="form-horizontal">
                <div class="modal-body">
                        <div class="row">
                            <div class="col-sm-6">
                                <label class="control-label" for="quantity_qty">{#quantity_cart#|ucfirst} :</label>
                            </div>
                            <div class="col-sm-6">
                ...
                <div class="modal-footer">
                    <input type="submit" id="update_qty" class="btn btn-box btn-flat btn-dark-theme" value="{#edit#|ucfirst}" />
                </div>
            </form>
        </div>
    </div>
